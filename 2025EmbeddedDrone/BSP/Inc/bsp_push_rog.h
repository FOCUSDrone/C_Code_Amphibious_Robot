...
#define PUSH_ROG_ON_PWM     20000
#define PUSH_ROG_OFF_PWM    0
...
extern void elongate_left_push_rog(uint16_t pwm);
extern void shorten_left_push_rog(uint16_t pwm);
extern void elongate_right_push_rog(uint16_t pwm);
extern void shorten_right_push_rog(uint16_t pwm);
