...
static void buzzer_beep_pattern(void);
...
void buzzer_task(void const * argument)
{
    ...
    while(1)
    {
        ...
        //find error
        //发现错误
        for(error_num = 0; error_num < ERROR_LIST_LENGHT-1; error_num++)
        {
...
/**
  * @brief          Play a predefined beep pattern for notification
  * @retval         none
  */
static void buzzer_beep_pattern(void)
{
